...
The boxplot was unequal without normalization, and after it, all boxes were at the same level, which can be seen in the file QCPlots_Norm.pdf, *figure 1*.
...
*The volcano plot can be found in the file Volcanos.pdf*.

To do all of this I had to create a linear model, in which you can find more information in the directory *Exercise_2*, the file called *Linear_Model_Contrast_Matrix.Rmd*.
...
As I have said, these genes can be found in the *TopTable.end.csv* file. 
