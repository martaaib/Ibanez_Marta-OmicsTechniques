...
```{r}
columnDesc <- data.frame(labelDescription = c("Sample Names", "Cells", "Groups"))
...
```{r}
myEset <- ExpressionSet(assayData = expression, fetureNames = mycells, phenoData = myAnnotDF, experimentData = myDesc)
show(myEset)
```
